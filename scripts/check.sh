...
cargo fmt --manifest-path "$project_dir/tools/decky-power-test/Cargo.toml" --all -- --check
cargo clippy --manifest-path "$project_dir/tools/decky-power-test/Cargo.toml" --all-targets -- -D warnings
