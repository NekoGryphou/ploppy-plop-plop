...
export function Settings(): JSX.Element {
  ...
  if (editing) return <PanelSection title={editing === "new" ? "Add PC" : "Edit PC"}><PanelSectionRow><DeviceForm device={editing === "new" ? undefined : editing} onSaved={finished} onCancel={() => setEditing(undefined)}/></PanelSectionRow></PanelSection>;
