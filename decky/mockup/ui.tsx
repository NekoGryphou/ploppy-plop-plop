...
type BasicProps = PropsWithChildren<{ style?: CSSProperties; onClick?: () => void; disabled?: boolean; className?: string; "aria-label"?: string; label?: ReactNode; description?: ReactNode }>;
...
export function Field({ children, label, description }: BasicProps) { return <label className="field"><span>{label}</span>{description}{children}</label>; }
