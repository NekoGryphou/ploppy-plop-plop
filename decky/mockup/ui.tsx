...
type BasicProps = PropsWithChildren<{ style?: CSSProperties; onClick?: () => void; disabled?: boolean; className?: string; "aria-label"?: string; label?: ReactNode; description?: ReactNode; childrenLayout?: "below" | "inline"; childrenContainerWidth?: string; bottomSeparator?: string; padding?: string }>;
...
export function TextField(props: { style?: CSSProperties; value?: string; onChange?: (event: { target: { value: string } }) => void; disabled?: boolean; inputMode?: "numeric" }) { return <input {...props}/>; }
